...
echo ""
echo "To debug: gdb build/build/RelWithDebInfo/src/node-exe/kth"
echo "  Or with args: gdb --args build/build/RelWithDebInfo/src/node-exe/kth -c config.cfg"

# Run tests if specified
if [ "$TEST" != "0" ]; then
    echo "Running tests..."
    cd build/build/RelWithDebInfo
