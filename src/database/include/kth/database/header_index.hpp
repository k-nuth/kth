...
#ifndef KTH_DATABASE_HEADER_INDEX_HPP
#define KTH_DATABASE_HEADER_INDEX_HPP
...
struct KD_API header_index {
    ...
    [[nodiscard]] uint256_t get_chain_work(index_t idx) const;
    ...
    void set_chain_work(index_t idx, uint256_t const& work);
...
#endif // KTH_DATABASE_HEADER_INDEX_HPP
