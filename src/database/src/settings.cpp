...
constexpr auto get_db_max_size_mainnet(db_mode_type mode) {
...
settings::settings()
    : directory(u8"blockchain"), db_mode(db_mode_type::blocks), reorg_pool_limit(100)  // TODO(fernando): look for a good default
      ,
