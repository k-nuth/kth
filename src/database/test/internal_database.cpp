...
void close_everything(KTH_DB_env* e, KTH_DB_dbi& db0, KTH_DB_dbi& db1, KTH_DB_dbi& db2, KTH_DB_dbi& db3, KTH_DB_dbi& db4, KTH_DB_dbi& db5, KTH_DB_dbi& db6, KTH_DB_dbi& db7, KTH_DB_dbi& db8, KTH_DB_dbi& db9, KTH_DB_dbi& db10, KTH_DB_dbi& db11) {
...
std::tuple<KTH_DB_env*, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi, KTH_DB_dbi> open_dbs() {
    KTH_DB_env* env_;
...
struct dummy_clock {
    ...
    static std::chrono::time_point<dummy_clock> now() noexcept {
...
TEST_CASE("internal database  reorg", "[None]") {
    ...
    std::tie(env_, dbi_utxo_, dbi_reorg_pool_, dbi_reorg_index_, dbi_block_header_, dbi_block_header_by_hash_, dbi_reorg_block_
             ...
             ,
             dbi_block_db_, dbi_transaction_db_, dbi_history_db_, dbi_spend_db_, dbi_transaction_hash_db_, dbi_transaction_unconfirmed_db_) = open_dbs();
    ...
    close_everything(env_, dbi_utxo_, dbi_reorg_pool_, dbi_reorg_index_, dbi_block_header_, dbi_block_header_by_hash_, dbi_reorg_block_, dbi_block_db_, dbi_transaction_db_, dbi_history_db_, dbi_spend_db_, dbi_transaction_hash_db_, dbi_transaction_unconfirmed_db_);
}
...
TEST_CASE("internal database  old blocks 0", "[None]") {
    ...
    // KTH_DB_txn* db_txn;
    std::tie(env_, dbi_utxo_, dbi_reorg_pool_, dbi_reorg_index_, dbi_block_header_, dbi_block_header_by_hash_, dbi_reorg_block_, dbi_block_db_, dbi_transaction_db_, dbi_history_db_, dbi_spend_db_, dbi_transaction_hash_db_, dbi_transaction_unconfirmed_db_) = open_dbs();
...
TEST_CASE("internal database  reorg index2", "[None]") {
    ...
    std::tie(env_, dbi_utxo_, dbi_reorg_pool_, dbi_reorg_index_, dbi_block_header_, dbi_block_header_by_hash_, dbi_reorg_block_
             ...
             ,
             dbi_transaction_db_, dbi_history_db_, dbi_spend_db_, dbi_transaction_hash_db_, dbi_transaction_unconfirmed_db_) = open_dbs();
    ...
    close_everything(env_, dbi_utxo_, dbi_reorg_pool_, dbi_reorg_index_, dbi_block_header_, dbi_block_header_by_hash_, dbi_reorg_block_
                     ...
                     ,
                     dbi_transaction_db_, dbi_history_db_, dbi_spend_db_, dbi_transaction_hash_db_, dbi_transaction_unconfirmed_db_);
}
