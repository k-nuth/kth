...
void ChaCha20Aligned::SetKey(Span<const uint8_t> key) noexcept {
...
ChaCha20Aligned::ChaCha20Aligned(Span<const uint8_t> key) noexcept {
    SetKey(key);
}
...
void ChaCha20Aligned::Keystream(Span<uint8_t> output) noexcept {
    unsigned char* c = reinterpret_cast<unsigned char *>(output.data());
...
void ChaCha20Aligned::Crypt(Span<const uint8_t> in_bytes, Span<uint8_t> out_bytes) noexcept {
    assert(in_bytes.size() == out_bytes.size());
    const unsigned char* m = reinterpret_cast<const unsigned char *>(in_bytes.data());
    unsigned char* c = reinterpret_cast<unsigned char *>(out_bytes.data());
