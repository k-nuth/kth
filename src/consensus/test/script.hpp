...
script_test_list valid_scripts{ { { "", "DEPTH 0 EQUAL", "Test the test: we should have an empty stack after scriptSig evaluation" },
...
script_test_list invalid_scripts{ { { "", "DEPTH", "Test the test: we should have an empty stack after scriptSig evaluation" },
