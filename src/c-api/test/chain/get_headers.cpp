...
// wire format is stable for the fields get_headers carries.
...
TEST_CASE("C-API GetHeaders - construct_unsafe matches safe variant",
          "[C-API GetHeaders]") {
    kth_hash_list_mut_t starts = make_hash_list_of_two();
...
TEST_CASE("C-API GetHeaders - to_data / from_data round-trip",
          "[C-API GetHeaders]") {
    kth_hash_list_mut_t starts = make_hash_list_of_two();
...
TEST_CASE("C-API GetHeaders - serialized_size matches to_data length",
          "[C-API GetHeaders]") {
    kth_hash_list_mut_t starts = make_hash_list_of_two();
...
TEST_CASE("C-API GetHeaders - equals distinguishes different instances",
          "[C-API GetHeaders]") {
    kth_hash_list_mut_t starts = make_hash_list_of_two();
...
// ---------------------------------------------------------------------------
// Getters / setters (inherited from get_blocks)
// ---------------------------------------------------------------------------
...
TEST_CASE("C-API GetHeaders - construct_from_data null data with non-zero size aborts",
          "[C-API GetHeaders][precondition]") {
    KTH_EXPECT_ABORT({
