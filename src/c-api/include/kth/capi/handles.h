...
typedef void* kth_abla_config_mut_t;
typedef void const* kth_abla_config_const_t;
typedef void* kth_abla_state_mut_t;
typedef void const* kth_abla_state_const_t;
