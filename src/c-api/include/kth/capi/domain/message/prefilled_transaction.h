...
#ifndef KTH_CAPI_DOMAIN_MESSAGE_PREFILLED_TRANSACTION_H_
#define KTH_CAPI_DOMAIN_MESSAGE_PREFILLED_TRANSACTION_H_
...
#endif // KTH_CAPI_DOMAIN_MESSAGE_PREFILLED_TRANSACTION_H_
