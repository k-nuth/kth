...
#ifndef KTH_CAPI_CHAIN_PREFILLED_TRANSACTION_LIST_H_
#define KTH_CAPI_CHAIN_PREFILLED_TRANSACTION_LIST_H_
...
/** @return Owned `kth_prefilled_transaction_list_mut_t`. Caller must release with `kth_chain_prefilled_transaction_list_destruct`. */
...
#endif /* KTH_CAPI_CHAIN_PREFILLED_TRANSACTION_LIST_H_ */
