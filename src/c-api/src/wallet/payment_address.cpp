...
void kth_wallet_payment_address_destruct(kth_payment_address_mut_t self) {
    ...
    delete &kth::cpp_ref<kth::domain::wallet::payment_address>(self);
}
...
kth_payment_address_mut_t kth_wallet_payment_address_copy(kth_payment_address_const_t self) {
    ...
    return new kth::domain::wallet::payment_address(kth::cpp_ref<kth::domain::wallet::payment_address>(self));
}
...
kth_bool_t kth_wallet_payment_address_equals(kth_payment_address_const_t self, kth_payment_address_const_t other) {
    ...
    return kth::bool_to_int(kth::cpp_ref<kth::domain::wallet::payment_address>(self) == kth::cpp_ref<kth::domain::wallet::payment_address>(other));
}
...
kth_bool_t kth_wallet_payment_address_valid(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    return kth::bool_to_int(static_cast<bool>(kth::cpp_ref<kth::domain::wallet::payment_address>(self)));
}

char* kth_wallet_payment_address_encoded_legacy(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    auto const s = kth::cpp_ref<kth::domain::wallet::payment_address>(self).encoded_legacy();
    return kth::create_c_str(s);
}

char* kth_wallet_payment_address_encoded_token(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    auto const s = kth::cpp_ref<kth::domain::wallet::payment_address>(self).encoded_token();
    return kth::create_c_str(s);
}

uint8_t kth_wallet_payment_address_version(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    return kth::cpp_ref<kth::domain::wallet::payment_address>(self).version();
}

uint8_t const* kth_wallet_payment_address_hash_span(kth_payment_address_const_t self, kth_size_t* out_size) {
    KTH_PRECONDITION(self != nullptr);
    KTH_PRECONDITION(out_size != nullptr);
    auto const span = kth::cpp_ref<kth::domain::wallet::payment_address>(self).hash_span();
    *out_size = span.size();
    return span.data();
}
...
kth_shorthash_t kth_wallet_payment_address_hash20(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    return kth::to_shorthash_t(kth::cpp_ref<kth::domain::wallet::payment_address>(self).hash20());
}

kth_hash_t kth_wallet_payment_address_hash32(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    return kth::to_hash_t(kth::cpp_ref<kth::domain::wallet::payment_address>(self).hash32());
}

kth_payment_t kth_wallet_payment_address_to_payment(kth_payment_address_const_t self) {
    KTH_PRECONDITION(self != nullptr);
    return kth::to_payment_t(kth::cpp_ref<kth::domain::wallet::payment_address>(self).to_payment());
}
...
kth_bool_t kth_wallet_payment_address_less(kth_payment_address_const_t self, kth_payment_address_const_t x) {
    ...
    auto const& x_cpp = kth::cpp_ref<kth::domain::wallet::payment_address>(x);
    return kth::bool_to_int(kth::cpp_ref<kth::domain::wallet::payment_address>(self).operator<(x_cpp));
}
...
char* kth_wallet_payment_address_encoded_cashaddr(kth_payment_address_const_t self, kth_bool_t token_aware) {
    ...
    auto const s = kth::cpp_ref<kth::domain::wallet::payment_address>(self).encoded_cashaddr(token_aware_cpp);
    return kth::create_c_str(s);
}
