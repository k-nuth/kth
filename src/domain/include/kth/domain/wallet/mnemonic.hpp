...
#ifndef KTH_DOMAIN_WALLET_MNEMONIC_HPP
#define KTH_DOMAIN_WALLET_MNEMONIC_HPP
 ...
 */
KD_API word_list create_mnemonic(byte_span entropy,
 ...
 */
KD_API long_hash decode_mnemonic_normalized_passphrase(word_list const& mnemonic, std::string const& normalized_passphrase);
