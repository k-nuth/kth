...
TEST_CASE("hd private encoded round trip expected", "[hd private tests]") {
    ...
    auto const key = hd_private::parse_from(encoded);
    REQUIRE(key);
...
TEST_CASE("hd private derive private short seed expected", "[hd private tests]") {
    ...
    REQUIRE(m0h12h2.to_string() == "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34sJ7in334");
    REQUIRE(m0h12h2x.to_string() == "xprvA41z7zogVVwxVSgdKUHDy1SKmdb533PjDz7J6N6mV6uS3ze1ai8FHa8kmHScGpWmj4WggLyQjgPie1rFSruoUihUZREPSL39UNdE3BBDu76");
}
...
TEST_CASE("hd private derive private long seed expected", "[hd private tests]") {
    ...
    REQUIRE(m0xH1yH.to_string() == "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXWYpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnMpCqE2VbFWc");
    REQUIRE(m0xH1yH2.to_string() == "xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4BYPJcr9E7j");
}
