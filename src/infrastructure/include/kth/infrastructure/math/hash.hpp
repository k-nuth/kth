...
// NOTE: boost::hash specializations commented out because modern Boost (container_hash)
// already supports std::array natively. These were causing conflicts with utxoz.
// namespace boost {
// template <size_t Size>
// struct hash<kth::byte_array<Size>> {
//     size_t operator()(const kth::byte_array<Size>& hash) const {
