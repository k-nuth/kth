...
#include <kth/infrastructure/deprecated/utility/delegates.hpp>
#include <kth/infrastructure/deprecated/utility/synchronizer.hpp>
...
public:
    ...
    /// The size of the dispatcher's threadpool.
    [[nodiscard]]
