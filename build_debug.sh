...
cmake .. -GNinja -DCMAKE_VERBOSE_MAKEFILE=ON -DBINLOG=OFF -DWITH_CONSOLE_CAPI=OFF -DDB_READONLY_MODE=OFF -DDB_NEW=ON -DDB_NEW_BLOCKS=ON -DENABLE_TESTS=OFF -DWITH_TESTS=OFF -DWITH_TOOLS=OFF -DENABLE_ECMULT_STATIC_PRECOMPUTATION=OFF  -DDB_NEW=ON -DDB_NEW_FULL=OFF -DCMAKE_BUILD_TYPE=Debug
